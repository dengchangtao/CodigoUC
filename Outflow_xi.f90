...
SUBROUTINE OUTFLOWN_xi(pasoRK,fopt,tipo,MC,Nx,Ny,Fr2,dep,hs,Ns,t,dt,q,zt,ep_x,ep2_x,qA,zA)
!Subrutina que fija una altura de agua en el borde xi=N del dominio

USE coords
USE time0
!Fija una altura afuera del dominio en el borde 0

implicit none
real (kind=8):: C,t,dt,Fr2,epA, hL, uL,vL, epL, epxL,epyL, RL,dep, zepL, epxA,epyA,zepA,tauL,Rmenos, hb,hA,zmin,uA,vA, Rmas, U1, alfa, uU,vU,U1u,hU,RmasU,uR,vR, Upar, UparR, UparL, JacA, Uper, epxA2, epyA2,h0,zumbral
...
!Rmas=0.0D0
  ...
  call fzeroEP_brent(j,borde,Fr2,Nx,dep,epx,epy,h,u,v,zep_x,dt,epL,epxL,epyL,uL,vL,hL,zepL)
...
!Rmenos=4.0D0*sqrt(epxA**2.0D0+epyA**2.0D0)*sqrt(hb/Fr2)
...
! print*, 'j=',j,'hA=',hA, 'hb=',hb!,Rmas,Rmenos, U1u
! print*, 'uA=',uA,'vA=',vA
! pause
! !.--------
! if (j==9) then
